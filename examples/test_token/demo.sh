...
dfx canister call test_token icrc7_token_metadata \
    "(vec{1})"

echo "(*) Owner of newly created Token:"
dfx canister call test_token icrc7_owner_of \
    "(vec{1})"

echo "(*) List of $YOU tokens:"
dfx canister call test_token icrc7_tokens_of \
...
echo '(*) Update Token:'
dfx canister call test_token update_token \
    "(record{
        token_id=1;
        token=record {
                name=\"updated test\";
...
dfx canister call test_token icrc7_transfer \
    "(vec{record{
