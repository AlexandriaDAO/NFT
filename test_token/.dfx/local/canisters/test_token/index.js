...
import { idlFactory } from './test_token.did.js';
export { idlFactory } from './test_token.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_TEST_TOKEN;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./test_token.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the test_token canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./test_token.did.js")._SERVICE>}
 */
export const test_token = createActor(canisterId);
